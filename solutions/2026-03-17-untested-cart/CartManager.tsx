    ...
    <div>
          ...
          <ul>
            {state.items.map((item) => (
              <li key={item.id} role="group" aria-label={item.name}>
                ...
                <span aria-label={`Quantity of item: ${item.name}`}>
                  {item.quantity}
                </span>
                <button
      ...
      <section aria-label="Coupon">
        ...
        {state.couponCode ? (
          ...
          <div>
            ...
            />
            <button role="button" aria-label="Apply coupon" onClick={handleApplyCoupon}>
              Apply
            </button>
          </div>
        )}
      ...
      <section aria-label="Order summary">
        ...
        <div>
          ...
          <div>
            <span>
              Discount ({state.couponDiscount ? (state.couponDiscount * 100).toFixed(0) : 0}% off):
            </span>
